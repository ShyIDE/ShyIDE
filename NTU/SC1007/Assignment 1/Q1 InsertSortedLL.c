...
int insertSortedLL(LinkedList *ll, int item)
{
    ...
    if (current == NULL) {
        ...
        ll->head->next = NULL;
        ll->size++;
        return 0; // Return index 0 for the first item in an empty list
    }
    ...
    // Insert the new node into the linked list at the appropriate position
    if (prev == NULL) {
    ...
    ll->size++; // Update the size of the linked list
    return index;
}
///////////////////////////////////////////////////////////////////////////////////
